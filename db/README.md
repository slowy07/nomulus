...
schema it is incompatible with, you will need to commit your schema changes in
...
similar addition of a constraint that will be violated by existing data.
